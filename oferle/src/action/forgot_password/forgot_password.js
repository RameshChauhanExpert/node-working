...
export var forgot_password_mail=(state)=>{
    ...
    return dispatch=>{
        ...
        if(state.email=="")
        {
            dispatch({type:"loader",response:{loader:false,snackbar:{show:true,message:"The email address must be required"}}})
            ...
            fetch(constant.base_url+constant.server_url.forgot_password,{
                method:"POST",
                headers:{
