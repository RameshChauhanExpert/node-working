...
import { forgot_password_mail } from "../../../action"
import { Loader } from "../..";
...
const actionCall = dispatch => ({
    send_mail: (state) => { dispatch(forgot_password_mail(state)) }
})
export default withRouter(connect(mapStateToProps, actionCall)(ForgotPassword))