...
import { RadioButton,SelectBox,TextBox, RangeSlider, DropzoneDialogExample,LocationInput } from "../../index";
  ...
  switch (islicensed) {
    case "1": return (
      <div className="form_wrapper requesting_offer licensed form-width-m">
        ...
        <div className="title-h4">Please enter owner name.</div>
        <TextBox max={[true,15,""]} label="Agent's First Name" type="text" name="agent_first_name" value={state.agent_first_name}  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter agent's first name"]}/>
        <TextBox max={[true,15,""]} label="Agent's Last Name" type="text" name="agent_last_name" value={state.agent_last_name}  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter agent's last name "]}/>
        <TextBox max={[true,70,""]} label="Agent's Email" type="text" name="agent_email_address" value={state.agent_email_address}  onBlur={true} email={[true,"Sorry you entered invalid email"]} state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter agent's email"]}/>
        <TextBox label="Agent's Phone Number" type="text" 
        min_value={[true,0,"Please enter valid phone number"]} 
        only_number={[true,"Phone number support only number"]}
         is_int={[true,"Please enter valid phone"]} 
         name="agent_phone_number" 
         max={[true,10,"Please enter valid phone number"]} 
         value={state.agent_phone_number}  
         state={state} 
         change={updateState} 
         validate={state.validate} 
         className="form-control-large" 
         required={[true,"Please enter agent's phone number"]}/>
        <TextBox max={[true,15,""]} label="Brokerage Name" type="text" name="brokerage_name"  state={state} value={state.brokerage_name}  change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter brokerage name"]}/>
...
function isGarage(index,updateState,state)
{
  ...
  <p className="form-label clearfix">How many cars?</p>
...
<div className="form_wrapper requesting_offer non-licensed form-width-m">
        <div className="title-h4">Please enter owner name.</div>
        <TextBox max={[true,15,""]} label="Owner First Name" type="text" name="owner_first_name"  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter owner first name"]}/>
        <TextBox max={[true,15,""]} label="Owner Last Name" type="text" name="owner_last_name"  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter owner last name"]}/>
        <TextBox max={[true,15,""]} label="Owner Phone Number" type="text" name="owner_phone_number" only_number={[true,"Phone number support only number"]} is_int={[true,"Please enter valid phone"]}  min_value={[true,0,"Please enter valid phone number"]} state={state} change={updateState} validate={state.validate} className="form-control-large" max={[true,10,"Phone number accept upto 10 digit."]} required={[true,"Please enter phone number"]}/>
        <TextBox max={[true,70,""]} label="Owner Email Address"
          type="text"
    ...
    case "0":
      return (<div className="sub-content">
        <div className="form_wrapper requesting_offer licensed form-width-m">
          ...
          <TextBox max={[true,15,""]} label="Owner First Name" type="text" name="owner_first_name"  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter owner first name"]}/>
          <TextBox max={[true,15,""]} label="Owner Last Name" type="text" name="owner_last_name"  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter owner last name"]}/>
          <TextBox max={[true,15,""]} label="Agent's First Name" type="text" name="agent_first_name"  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter agent's first name"]}/>
          <TextBox max={[true,15,""]} label="Agent's Last Name" type="text" name="agent_last_name"  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter agent's last name"]}/>
          <TextBox max={[true,70,""]} label="Agent's Email" type="text" name="agent_email_address"  state={state} change={updateState} validate={state.validate} className="form-control-large" onBlur={true} email={[true,"Sorry you entered invalid email"]} required={[true,"Please enter agent's email"]}/>
          ...
          <TextBox max={[true,15,""]} label="Brokerage Name" type="text" name="brokerage_name"  state={state} change={updateState} validate={state.validate} className="form-control-large" required={[true,"Please enter brokerage name"]}/>
                  </div>
      </div>)
  }
...
<TextBox label="Units" is_int={[true,"Please enter valid units"]} type="text" max={[true,2,"This field contain only 2 digits"]} only_number={[true,"This field support only number"]}  min_value={[true,0,"Please enter valid units"]} value={state.units} name="units"  state={state} change={updateState} validate={state.validate} className="form-control-m large-input"  required={[true,"Please enter units"]}/>
    ...
    default:return (<div className="units-wrapper">
          ...
          <SelectBox
            ...
            <p className="form-label clearfix"> Occupancy? *</p>
            <RadioButton 
              className="radio-options-common"
               data={[
                 {name:"Vacant",value:"0"},
                 {name:"Rented",value:"1"},
                 {name:"Owner occupied ",value:"2"}
                ...
                column="true"
              />
               {isOccupancy(state.occupancy,updateState,state)}
          </div>
...
function isCondo(index,updateState,state)
{
  switch(index)
  {
    ...
    <TextBox  max={[true,255,""]} label="How much are dues($)?" value={state.hoa_dues} min_value={[true,0,"Please enter valid amount."]} is_float={[true,"This field accept upto two decimal number."]} type="text" name="condo_dues"  state={state} change={updateState} validate={state.validate} className="form-control-m large-input"  required={[true,"Please enter condo's due. "]}/>
...
function rentalrestruction(index,updateState,state)
{
  switch(index){
    case "1":return( 
      <TextBox max={[true,255,""]} label="Owner restriction" type="text" name="owner_restruction"  state={state} change={updateState} validate={state.validate} className="form-control-m large-input owner_restriction_full" required={[true,"Please enter restrictions"]}/>
    )
  }
}
function isOccupancy(index,updateState,state)
{
 switch(index){
    case "1":return( 

      <TextBox  max={[true,255,""]} label="Monthly rent($)?" value={state.rent_amount_1} min_value_for_rent={[true,0,"Please enter valid amount."]} is_float={[true,"This field accept upto two decimal number ."]} type="text" name="occupancy_rent_amount"  required={[true,"Please enter rent."]} state={state} change={updateState} validate={state.validate} className="form-control-m large-input" />
  ...
  switch (step) {
    case 0:
      return (
        <div className="step-1">
          ...
          <div className="property_address" change={updateState}>
             ...
             <TextBox label="City" name="city" max={[true,30,""]} type="text" value={state.city} state={state} change={updateState} validate={state.validate} className="form-control-m" required={[true,"Please enter city"]}/>
             ...
             // is_float={[true,"This field contain number or one decimal with 1/2 digits"]}
              ...
              max={[true,6,""]} 
              min={[true,5,"Please enter valid zipcode"]} 
              ...
              className="radio-options-wrp"
               data={[
                ...
                name="is_owner"
                required={[true,"Please select these field."]}
                state={state} change={updateState} 
                validate={state.validate}
                row="true"
    ...
    case 1:
      ...
      return (<div className="step-r-wrapper">
       ...
       {(state.PropertyType==5)? <TextBox label="Sq ft" type="text" max={[true,255,""]} is_float={[true,"This field accept upto two decimal numbers"]}  name="sq_ft" value={state.sq_ft}  state={state} change={updateState} validate={state.validate} className="form-control-m" min_value={[true,0,"Please enter valid mesumerment"]} required={[true,"Please enter square feet"]}/>
        :""}
        {(state.PropertyType!=5&&state.PropertyType!=undefined)? <div><div className="unit-wrapper-single">
        {isMultiFamily(state.PropertyType,updateState,state)}
      </div>
      ...
      <SelectBox
        ...
        />
         <TextBox label="Sq ft" type="text" max={[true,255,""]} is_float={[true,"This field accept upto two decimal numbers"]}  name="sq_ft" value={state.sq_ft}  state={state} change={updateState} validate={state.validate} className="form-control-m" min_value={[true,0,"Please enter valid mesumerment"]} required={[true,"Please enter square feet"]}/>
          <div className="form-group-wrapper">
          ...
          <div className="form-group-wrapper">
            ...
            <RadioButton 
              className="radio-options-common"
               data={[
                 {name:"Wall unit AC",value:"1"},
                 {name:"Central AC",value:"0"}
                ]}
                name="cooling_system"
    ...
    case 2:
      return (<div className="step-r-wrapper owner_restriction_main">
        ...
        <div class="form-group-wrapper">
          <p className="form-label clearfix">Is there communities amenities?</p>
          <FormControl component="fieldset" >
            <FormGroup className="checkbox-group">
              ...
              <FormControlLabel name="amenities_spa" onChange={updateState} className="checkbox-input"
                ...
                label="Spa"
              />
              <FormControlLabel name="amenities_golf" onChange={updateState} className="checkbox-input"
                control={
                  <Checkbox value={(state.amenities_golf==1)?"":1} checked={(state.amenities_golf==1)?true:false} color="primary" />
                }
                label="Golf"
              />
              ...
              />
              {/* <TextField label="Other"  max={[true,255,""]} name="amenities_other" onChange={updateState} className="form-control-m other-input" margin="normal"/>
              */}
              {/* <TextBox 
              max={[true,255,""]} 
              label="Other"
    ...
    case 3:
      return (
        <div className="house_condition_wrapper">
          ...
          <div className="title-h4">Items they need to rate:</div>
          ...
          <div className="textarea-wrapper">
            <h4> Any Other condition issue wee need to know about it :(i.e settlement issues/mold/fire damage/code violation/open permits etc)</h4> 
