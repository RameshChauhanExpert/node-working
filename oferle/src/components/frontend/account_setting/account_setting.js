...
import { signup, submit_edit_profile_data,seller_changePassword } from "../../../action/"
...
class AccountSetting extends React.Component {
  ...
  passwordSubmit=(event)=>{
    ...
    {
      if( this.state.conifrm_new_password!="")
      this.setState({password_err:"Those passwords did't match.Try again."})
      ...
      if (this.elementIndex == this.totalElement) {
        ...
        if (this.isValidateAll == this.totalElement) {
          if(this.state.value==0)
          {
            ...
            this.props.seller_changePassword(this.state)
          }
...
<div >  
  <div className="tabs-main-wrapper account-settings">
        ...
        {value === 1 && <TabContainer className="tab-content-wrapper">
          ...
          <div className="for_register_login">
          <div className="account-setting-wrapper card-block">
          <h3 className="heading-h3">Change Password</h3>
            <form action="#" onSubmit={this.passwordSubmit} className="form__wrapper ">
              ...
              <div className="form-field register_signup">
                ...
                />
                <span className="error">{this.state.password_err}</span>
              </div>
              </div>
...
const actionCall = dispatch => ({
  ...
  seller_changePassword:(state)=>{dispatch(seller_changePassword(state))}
})
