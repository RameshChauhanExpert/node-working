...
class Common_model extends CI_Model {
    ...
    ****************************************/
    public function getRowsMultipleWhere($tablename,$wherearray)
    {
	  ...
	  /****************************************
    Function: getAllRows, get row from table in array format 
    $tablename: Name of table        
    $wherearray: where field array    
    ****************************************/
	...
	************************/
	public function checkAlreadyExist($tablename,$wherearray,$fieldName,$fieldValue){
		$this->db->where($wherearray);
		if($fieldValue){
    ...
    // get num of rows 
    public function getNumRows($wherefieldname,$wherefieldvalue,$tablename){
        $this->db->where($wherefieldname,$wherefieldvalue);
